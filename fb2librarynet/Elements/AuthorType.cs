...
namespace FB2Library.HeaderItems
{
    ...
    public class AuthorType 
    {
        ...
        public const string PainterElementName = "painter";
        ...
        //
        private const string AuthorTypeElementName = "AuthorType";
        //
       ...
       /// <summary>
        /// Author's type (автор,под редакцией, составитель и т.д.)
        /// </summary>
        public TextFieldType A_Type { get; set; }
        ...
        internal void Load(XElement xElement)
        {
            ...
            // Load AuthorType
            A_Type = null;
            XElement xAuthorType = xElement.Element(fileNameSpace + AuthorTypeElementName);
            if (xAuthorType != null)
            {
                try
                {
                    A_Type = new TextFieldType();
                    A_Type.Load(xUID);
                }
                catch (Exception)
                {
        ...
        public XElement ToXML( )
        {
            ...
            if (A_Type != null)
            {
                xPerson.Add(A_Type.ToXML(AuthorTypeElementName));
            }
